...
function FORMS_FileBrowser(_props = undefined): FORMS_CompoundWidget(_props) constructor
{
	...
	Toolbar = new(function (): FORMS_Container() constructor
	{
		...
		static draw_content = function ()
		{
			...
			var _padX = Pen.PaddingX ?? forms_get_style().Padding;
			Pen.input("input-search-folder", "",
			{
				Width: FileBrowser.Dock.get_first().__realWidth - _padX,
				Placeholder: "Search folders..."
			});
			Pen.input("input-search-file", "",
			{
				Width: __realWidth - Pen.X - _padX - 4,
	...
	/// @readonly
	FileTree = new (function (_fileBrowser): FORMS_ScrollPane() constructor
	{
