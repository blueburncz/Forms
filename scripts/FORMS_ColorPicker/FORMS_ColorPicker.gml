	...
	set_widget(new (function () : FORMS_Container() constructor
	{
		...
		static __draw_color_wheel = function()
		{
			...
			if (WheelSelected) {
				...
				Parent.Color.set_from_hsva(PickerHue / 360, PickerSaturation / 100, PickerValue / 100, PickerAlpha);
			...
			draw_sprite_ext(FORMS_SprColorPickerCircle, 1, _colorWheelCursorX, _colorWheelCursorY, PickerCursorSize, PickerCursorSize, 0, Parent.Color.get(), 1);
		...
		{				
			...
			switch (PickerMode) 
			{
				case "RGB":
					...
					Parent.ColorNew.set_from_rgba(_red / 255, _green / 255, _blue / 255, PickerAlpha);
				...
				case "HSV":
					...
					Parent.ColorNew.set_from_hsva(PickerHue / 360, PickerSaturation / 100, PickerValue / 100, PickerAlpha);
